...
class SetOddsCalculator(BaseOddsCalculator):
    ...
    def calculate(self):
        ...
        if counts[0] == 2:
            ...
            remaining = 4 - rank_counts[pair_rank]

            favorable = total_runouts - comb(
                self.unseen_cards_count - remaining, self.cards_to_come
            )
